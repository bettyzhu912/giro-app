...
def main():
    ...
    # Prompts to feed in
    prompt_1="based on the first image in this collection, what's the name under which the business is conducted? Do not return other words not in the document and do not change your response if i dont change the prompt"
    ...
    prompt_3="based on the first image in this collection, give full details of activities you undertake and of any intended charge in these. Do not return other words not in the document and do not change your response if i dont change the prompt"
