...
def main():
    ...
    # Prompts to feed in
    prompt_1="on the first image in this collection, simply return me the name in the first box. Do not return other words not in the document and do not change your response if i dont change the prompt"
    ...
    prompt_3="on the first image in this collection, simply return the sentences under '4. give full details of activities you undertake and of any intended charge in these'. Do not return other words not in the document and do not change your response if i dont change the prompt"
